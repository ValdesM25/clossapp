...
export const DEMO_ESCROW_ORDERS = [
  {
    id: "escrow_demo_1",
    orderCode: "ESC-48291",
    qrToken: "ESC-QR-88A92B",
    buyerUserId: "guest",
    buyerName: "Mariela Morales",
    buyerEmail: "mariela@clossapp.com",
    items: [
      {
        id: "item_demo_1",
        prenda: {
    ...
    status: "pago_en_custodia" as const,
    puntoAcopioId: "norte",
